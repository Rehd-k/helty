            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionHeader('Batch Details', Icons.qr_code_outlined),
                  Row(
                    children: [
                      Expanded(
        ...
        SizedBox(
          ...
          child: FilledButton(
            ...
            child: _isLoading
                ...
                : Text('Save all batches (${_pendingEntries.length})'),
          ),
        ),
      ],
    );
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              leading: CircleAvatar(
                ...
                child: Icon(Icons.inventory_2, color: scheme.primary, size: 22),
              ),
              title: Text(
                pickedItem.itemName,
