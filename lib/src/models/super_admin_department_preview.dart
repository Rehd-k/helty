...
const List<SuperAdminHubDepartment> kSuperAdminHubDepartments = [
  ...
  SuperAdminHubDepartment(
    ...
    previewRole: 'hmo_head',
    previewBannerLabel: 'HMO Desk (Head)',
  ),
  SuperAdminHubDepartment(
  ...
  SuperAdminHubDepartment(
    ...
    previewRole: 'physician_head',
    previewBannerLabel: 'Physician (Head)',
  ),
  SuperAdminHubDepartment(
  ...
  SuperAdminHubDepartment(
    ...
    previewRole: 'medical_records_head',
    previewBannerLabel: 'Medical Records (Head)',
  ),
  SuperAdminHubDepartment(
    category: StaffAccountCategory.frontDesk,
    tileTitle: 'Front Desk',
    previewAccountType: 'front_desk',
    previewRole: 'front_desk_head',
    previewBannerLabel: 'Front Desk (Head)',
  ),
  SuperAdminHubDepartment(
    category: StaffAccountCategory.ict,
    tileTitle: 'ICT',
    previewAccountType: 'ict',
    previewRole: 'ict_head',
    previewBannerLabel: 'ICT (Head)',
  ),
  SuperAdminHubDepartment(
    category: StaffAccountCategory.janitor,
    tileTitle: 'Housekeeping',
    previewAccountType: 'janitor',
    previewRole: 'janitor_head',
    previewBannerLabel: 'Housekeeping (Head)',
  ),
  SuperAdminHubDepartment(
