...
/// Compact command-center KPI cards with solid icon tiles.
class CmdCommandKpiStrip extends StatelessWidget {
  const CmdCommandKpiStrip({
    super.key,
    required this.items,
    this.useSnapStrip = false,
  });

  final List<CmdCommandKpiItem> items;
  ...
  Widget build(BuildContext context) {
    ...
    if (useSnapStrip || items.length > 4) {
      return SizedBox(
        height: 78,
