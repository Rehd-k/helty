...
class OngoingEncountersFilterBar extends StatelessWidget {
  const OngoingEncountersFilterBar({
    super.key,
  ...
  Widget _searchField(BuildContext context) {
    return TextField(
      ...
      decoration: _decoration(
        ...
        icon: Icons.search,
        iconColor: OngoingEncountersMetrics.iconIndigo,
      ),
  ...
  Widget _scopeDropdown(BuildContext context) {
    return DropdownButtonFormField<bool>(
      ...
      decoration: _decoration(
        ...
        iconColor: OngoingEncountersMetrics.iconPink,
      ),
      items: const [
        DropdownMenuItem<bool>(
          value: false,
          child: Text('All ongoing', overflow: TextOverflow.ellipsis),
        ),
        DropdownMenuItem<bool>(
          value: true,
  ...
  Widget _visitTypeDropdown(BuildContext context) {
    return DropdownButtonFormField<String?>(
      ...
      decoration: _decoration(
        ...
        iconColor: OngoingEncountersMetrics.waitAmber,
      ),
      items: [
  ...
  Widget build(BuildContext context) {
    final filterButton = _filterIconButton(
      onPressed:
          onOpenFilterMenu ??
          () => showOngoingEncountersFilterMenu(context, this),
    );
...
Future<void> showOngoingEncountersFilterMenu(
  BuildContext context,
  OngoingEncountersFilterBar filterBar,
) {
