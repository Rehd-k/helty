...
class CompletedEncountersSidebar extends StatelessWidget {
  const CompletedEncountersSidebar({
    super.key,
  ...
  final List<CompletedDoctorCount> doctorCounts;
  final List<CompletedActivityNote> notes;
        ...
        children: [
          Row(
            children: [
              const HeltySolidIcon(
                icon: Icons.flash_on,
                color: CompletedEncountersMetrics.waitAmber,
                size: 26,
                iconSize: 14,
                radius: 7,
              ),
          ...
          _GradientActionButton(
            ...
            colors: [
              ...
              Color.lerp(CompletedEncountersMetrics.waitAmber, cs.error, 0.15)!,
            ],
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        height: 8,
                        decoration: BoxDecoration(
                          color: CompletedEncountersMetrics.colorForVisitType(
                            row.name,
                            cs.primary,
                          ),
        ...
        Row(
          children: [
            const HeltySolidIcon(
              ...
              color: CompletedEncountersMetrics.iconBlue,
              size: 26,
              iconSize: 14,
              radius: 7,
            ),
        ...
        Row(
          children: [
            const HeltySolidIcon(
              ...
              color: CompletedEncountersMetrics.iconTeal,
              size: 26,
              iconSize: 14,
              radius: 7,
            ),
...
Future<void> showCompletedEncountersNotesDialog(
  BuildContext context,
  List<CompletedActivityNote> notes,
) {
