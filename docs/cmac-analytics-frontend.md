...
This document is the contract between the hospital backend and the CMAC oversight dashboard frontend. All routes require a valid JWT (`Authorization: Bearer <token>`) and **SUPER_ADMIN** staff access.
...
| 403 | Not SUPER_ADMIN (analytics) or insufficient access |
